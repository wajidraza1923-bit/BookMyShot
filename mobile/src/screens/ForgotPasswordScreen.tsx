...
const s = StyleSheet.create({
  ...
  backBtn: { position: 'absolute', top: Platform.OS === 'ios' ? 56 : 44, left: 0, width: 36, height: 36, borderRadius: 18, backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center' },
  ...
  subtitle: { fontSize: 13, color: '#9CA3AF', textAlign: 'center', marginTop: 8, marginBottom: 28, lineHeight: 19 },
  inputRow: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#F8F6FF', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 14, paddingHorizontal: 14, height: 50 },
  ...
  otpBox: { width: 44, height: 52, borderRadius: 12, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.1)', backgroundColor: '#F8F6FF', textAlign: 'center', fontSize: 20, fontWeight: '700', color: '#1F2937' },
