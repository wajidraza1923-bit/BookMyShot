...
const s = StyleSheet.create({
  ...
  filterBtnT: { fontSize: 11, fontWeight: '700', color: '#fff' },
  ...
  marker: { width: 34, height: 34, borderRadius: 17, borderWidth: 2.5, borderColor: '#6C3BFF', overflow: 'hidden', backgroundColor: '#fff' },
  markerImg: { width: '100%', height: '100%' },
  searchAreaBtn: { position: 'absolute', top: 10, alignSelf: 'center', flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#fff', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 7, elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 3 },
  searchAreaT: { fontSize: 10, fontWeight: '600', color: '#6C3BFF' },
  locFab: { position: 'absolute', bottom: 10, right: 10, width: 34, height: 34, borderRadius: 17, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 3 },
  // Trust
  ...
  card: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 16, marginBottom: 12, borderWidth: 1, borderColor: '#F1F5F9', overflow: 'hidden', elevation: 2, shadowColor: '#6C3BFF', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 6 },
  ...
  onlineT: { fontSize: 7, color: '#fff', fontWeight: '600' },
  ratingBadge: { position: 'absolute', bottom: 6, left: 5, backgroundColor: 'rgba(0,0,0,0.6)', borderRadius: 6, paddingHorizontal: 5, paddingVertical: 2 },
  ratingT: { fontSize: 8, color: '#fff', fontWeight: '700' },
  ...
  actionTFilled: { fontSize: 9, fontWeight: '700', color: '#fff' },
  // Empty
  ...
  emptyBtnT: { fontSize: 12, fontWeight: '700', color: '#fff' },
  // States
  ...
  retryT: { fontSize: 12, fontWeight: '700', color: '#fff' },
  // Modals
  modalBg: { flex: 1, backgroundColor: 'rgba(0,0,0,0.35)', justifyContent: 'flex-end' },
  sheet: { backgroundColor: '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: Platform.OS === 'ios' ? 40 : 30, maxHeight: '75%' },
  ...
  applyT: { fontSize: 13, fontWeight: '700', color: '#fff' },
  // Sort options
