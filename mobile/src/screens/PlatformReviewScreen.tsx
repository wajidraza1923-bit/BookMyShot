...
const st = StyleSheet.create({
  ...
  topSub: { fontSize: 11, color: 'rgba(255,255,255,0.4)', marginTop: 4, textAlign: 'center' },
  label: { fontSize: 11, fontWeight: '600', color: 'rgba(255,255,255,0.5)', marginBottom: 6, marginTop: 14 },
  starsRow: { flexDirection: 'row', justifyContent: 'center', gap: 6 },
  starBtn: { padding: 4 },
  ratingLabel: { textAlign: 'center', fontSize: 12, color: '#FF8C2B', fontWeight: '700', marginTop: 4, marginBottom: 6 },
  ...
  submitBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#FF8C2B', borderRadius: 12, paddingVertical: 14, marginTop: 24 },
