...
const s = StyleSheet.create({
  ...
  loadingText: { fontSize: 12, color: 'rgba(255,255,255,0.3)', marginTop: 10 },
  // Empty
  empty: { alignItems: 'center', paddingTop: 50, paddingHorizontal: 30 },
  emptyTitle: { fontSize: 15, fontWeight: '600', color: 'rgba(255,255,255,0.5)', marginTop: 12 },
  emptyText: { fontSize: 11, color: 'rgba(255,255,255,0.3)', marginTop: 6, textAlign: 'center' },
  emptyNote: { fontSize: 10, color: 'rgba(255,140,43,0.4)', marginTop: 10, textAlign: 'center', fontStyle: 'italic' },
  // Item Card
  itemCard: { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 10, backgroundColor: 'rgba(255,255,255,0.02)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', marginBottom: 8 },
  itemCardInactive: { opacity: 0.55, borderColor: 'rgba(107,114,128,0.2)' },
  itemThumb: { width: 50, height: 50, borderRadius: 8, backgroundColor: 'rgba(255,255,255,0.05)' },
  itemThumbPlaceholder: { width: 50, height: 50, borderRadius: 8, backgroundColor: 'rgba(255,255,255,0.03)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', alignItems: 'center', justifyContent: 'center' },
  itemIconWrap: { width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(255,140,43,0.08)', borderWidth: 1, borderColor: 'rgba(255,140,43,0.15)', alignItems: 'center', justifyContent: 'center' },
  itemInfo: { flex: 1, minWidth: 0 },
  itemNameRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  itemName: { fontSize: 13, fontWeight: '600', color: '#fff', flex: 1 },
  hiddenBadge: { backgroundColor: 'rgba(107,114,128,0.2)', paddingHorizontal: 5, paddingVertical: 1, borderRadius: 4 },
  hiddenBadgeText: { fontSize: 7, fontWeight: '700', color: '#6B7280' },
  verifiedBadge: { marginLeft: 2 },
  itemSub: { fontSize: 10, color: 'rgba(255,255,255,0.4)', marginTop: 2 },
  itemReview: { fontSize: 9, color: 'rgba(255,255,255,0.3)', marginTop: 3, fontStyle: 'italic', lineHeight: 13 },
  itemDate: { fontSize: 8, color: 'rgba(255,255,255,0.2)', marginTop: 3 },
  // Actions
  itemActions: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  reorderCol: { alignItems: 'center', marginRight: 4 },
  reorderBtn: { padding: 2 },
  orderNum: { fontSize: 8, color: 'rgba(255,255,255,0.3)' },
  toggleBtn: { width: 26, height: 26, borderRadius: 13, alignItems: 'center', justifyContent: 'center' },
  toggleOn: { backgroundColor: 'rgba(16,185,129,0.1)' },
  toggleOff: { backgroundColor: 'rgba(107,114,128,0.1)' },
  editBtn: { width: 26, height: 26, borderRadius: 13, backgroundColor: 'rgba(59,130,246,0.1)', alignItems: 'center', justifyContent: 'center' },
  deleteBtn: { width: 26, height: 26, borderRadius: 13, backgroundColor: 'rgba(239,68,68,0.08)', alignItems: 'center', justifyContent: 'center' },
  // Modal
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.85)', justifyContent: 'flex-end' },
  modalContent: { maxHeight: '90%', backgroundColor: '#0F0E0D', borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingHorizontal: 20, paddingBottom: Platform.OS === 'ios' ? 40 : 20 },
  ...
  editingInfo: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(59,130,246,0.06)', borderWidth: 1, borderColor: 'rgba(59,130,246,0.15)', borderRadius: 10, padding: 10, marginBottom: 14 },
  editingInfoText: { fontSize: 10, color: 'rgba(59,130,246,0.8)', flex: 1 },
  // Form
  fieldGroup: { marginBottom: 14 },
  fieldLabel: { fontSize: 10, fontWeight: '600', color: 'rgba(255,255,255,0.5)', marginBottom: 6, letterSpacing: 0.3, textTransform: 'uppercase' },
  fieldInput: { backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13, color: '#fff' },
  boolToggle: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10 },
  boolToggleActive: { borderColor: 'rgba(16,185,129,0.3)', backgroundColor: 'rgba(16,185,129,0.05)' },
  boolDot: { width: 14, height: 14, borderRadius: 7, backgroundColor: '#6B7280' },
  boolDotActive: { backgroundColor: '#10B981' },
  boolText: { fontSize: 12, color: '#fff' },
