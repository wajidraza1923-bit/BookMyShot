...
const st = StyleSheet.create({
  ...
  subtitle: { fontSize: 10, color: 'rgba(255,255,255,0.35)', marginTop: 1 },
  // Search
  searchRow: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 16, marginTop: 8, backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', paddingHorizontal: 12, height: 40, gap: 8 },
  searchInput: { flex: 1, fontSize: 13, color: '#fff' },
  // Districts
  distScroll: { marginTop: 12, maxHeight: 90 },
  distCard: { alignItems: 'center', width: 65 },
  distCardActive: {},
  distImg: { width: 50, height: 50, borderRadius: 25, borderWidth: 2, borderColor: 'rgba(255,255,255,0.06)' },
  ...
  cardMeta: { fontSize: 10, color: 'rgba(255,255,255,0.4)', marginTop: 2 },
  cardBio: { fontSize: 10, color: 'rgba(255,255,255,0.3)', marginTop: 4, lineHeight: 14 },
  cardRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 6 },
  cardRating: { fontSize: 11, color: 'rgba(255,255,255,0.6)' },
  cardReviews: { fontSize: 9, color: 'rgba(255,255,255,0.3)' },
  cardPrice: { fontSize: 11, fontWeight: '700', color: '#FF8C2B', marginLeft: 'auto' },
  ...
  viewBtnText: { fontSize: 11, fontWeight: '600', color: '#FF8C2B' },
  // Empty
  empty: { alignItems: 'center', paddingTop: 50 },
  emptyTitle: { fontSize: 13, color: 'rgba(255,255,255,0.4)', marginTop: 10 },
