...
const s = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, color: '#6B7280', textAlign: 'center', marginTop: 8, lineHeight: 19, maxWidth: 300 },
  amountsCard: { width: '100%', backgroundColor: '#F8F6FF', borderWidth: 1, borderColor: 'rgba(249,115,22,0.15)', borderRadius: 14, padding: 18, marginTop: 24 },
  amountsTitle: { fontSize: 11, fontWeight: '700', color: '#F97316', letterSpacing: 0.5, marginBottom: 12 },
  amountRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
  ...
  rulesCard: { width: '100%', padding: 14, marginTop: 16, backgroundColor: '#FAFAFA', borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  rulesTitle: { fontSize: 11, fontWeight: '700', color: '#6B7280', marginBottom: 8 },
  ruleRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 6 },
  ruleText: { fontSize: 11, color: '#6B7280', flex: 1 },
  manualCard: { flexDirection: 'row', alignItems: 'center', gap: 10, width: '100%', padding: 14, marginTop: 24, backgroundColor: '#F8F6FF', borderRadius: 10, borderWidth: 1, borderColor: '#F1F5F9' },
  manualText: { flex: 1, fontSize: 12, color: '#9CA3AF', lineHeight: 17 },
  ...
  logoutText: { fontSize: 12, color: '#9CA3AF', fontWeight: '600' },
});
