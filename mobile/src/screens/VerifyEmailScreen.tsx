...
const s = StyleSheet.create({
  ...
  backBtn: { position: 'absolute', top: Platform.OS === 'ios' ? 56 : 44, left: 20, width: 36, height: 36, borderRadius: 18, backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center', zIndex: 10 },
