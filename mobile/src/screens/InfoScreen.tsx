...
const PAGES: Record<string, { title: string; content: any[] }> = {
  ...
  FAQ: {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Free plan: 3 free leads. Premium plan: Monthly/Yearly subscription for unlimited leads and features. platform commission (as per Admin settings) on confirmed booking advances.' },
      ...
      { type: 'paragraph', text: 'Cashback is credited only after the creator marks "Payment Completed" in their dashboard AND the confirmation happens within the admin-configured deadline from booking date. Cashback is calculated on your Razorpay booking fee amount using the platform\'s current cashback percentage.' },
      ...
      { type: 'paragraph', text: 'You will not receive cashback. The cashback is not eligible if the creator confirms payment after the payment deadline (set by Admin) from the booking date. This rule applies automatically and cannot be reversed.' },
  ...
  Terms: {
    ...
    content: [
      ...
      { type: 'heading', text: '5. Cashback Payment Policy' },
      ...
      { type: 'bullet', items: ['Payment within deadline (Admin-configured) + creator confirms = Cashback credited', 'Payment after deadline = No cashback, amount retained by BookMyShot', 'This rule applies automatically and cannot be reversed', 'Booking date is the date the booking was created on the platform'] },
  ...
  Help: {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'BookMyShot charges 3-platform commission (as per Admin settings) on bookings. Commission is calculated on the highest deal amount.' },
