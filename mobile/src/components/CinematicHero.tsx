...
const st = StyleSheet.create({
  ...
  // Logo
  logoWrap: { width: 100, height: 100, alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  logoGlow: { position: 'absolute', width: 120, height: 120, borderRadius: 60, backgroundColor: 'rgba(249,115,22,0.06)' },
  ringOut: { position: 'absolute', width: 92, height: 92, borderRadius: 46, borderWidth: 0.8, borderColor: 'rgba(249,115,22,0.1)' },
  ringIn: { position: 'absolute', width: 72, height: 72, borderRadius: 36, borderWidth: 1.5, borderColor: 'rgba(249,115,22,0.16)' },
  ...
  eyebrow: { fontSize: 7, fontWeight: '700', color: '#F97316', letterSpacing: 3.5, marginBottom: 10 },
  h1a: { fontSize: 24, fontWeight: '200', color: '#fff', textAlign: 'center', lineHeight: 29 },
  h1b: { fontSize: 28, fontWeight: '800', color: '#FFB347', textAlign: 'center', lineHeight: 34, textShadowColor: 'rgba(249,115,22,0.25)', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 14 },
  textSweep: { position: 'absolute', top: 0, width: 55, height: '100%', backgroundColor: 'rgba(255,220,130,0.04)', transform: [{ skewX: '-15deg' }] },
  sub: { fontSize: 11, color: 'rgba(255,255,255,0.35)', textAlign: 'center', marginTop: 8, lineHeight: 16, maxWidth: 260 },
  btns: { flexDirection: 'row', gap: 9, marginTop: 16 },
  btnP: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#F97316', paddingHorizontal: 18, paddingVertical: 11, borderRadius: 10, shadowColor: '#F97316', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6 },
