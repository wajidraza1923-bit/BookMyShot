...
const st = StyleSheet.create({
  ...
  // Live
  liveWrap: { flexDirection: 'row', alignItems: 'center', alignSelf: 'center', gap: 5, backgroundColor: 'rgba(255,255,255,0.015)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.03)', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 4, marginBottom: 12 },
  ...
  eyebrow: { fontSize: 8, fontWeight: '700', color: '#F97316', letterSpacing: 3, marginBottom: 10, textAlign: 'center' },
  h1a: { fontSize: 28, fontWeight: '300', color: '#fff', textAlign: 'center', lineHeight: 34, letterSpacing: -0.5 },
