...
const st = StyleSheet.create({
  ...
  h1a: { fontSize: 22, fontWeight: '200', color: '#fff', textAlign: 'center', lineHeight: 28 },
  h1b: { fontSize: 26, fontWeight: '800', color: '#FFB347', textAlign: 'center', lineHeight: 32, textShadowColor: 'rgba(249,115,22,0.3)', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 16 },
  textSweep: { position: 'absolute', top: 0, width: 55, height: '100%', backgroundColor: 'rgba(255,220,130,0.04)', transform: [{ skewX: '-15deg' }] },
  sub: { fontSize: 11, color: 'rgba(255,255,255,0.4)', textAlign: 'center', marginTop: 6, lineHeight: 16, maxWidth: 280 },
