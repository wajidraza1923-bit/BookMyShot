...
const subscriptionSettingsSchema = new mongoose.Schema(
  {
    ...
    yearlyButtonText: { type: String, default: "Buy Yearly Plan" },
    yearlyBenefits: { type: String, default: "Unlimited invoices, Priority ranking, Premium badge, 12 months access, No AutoPay required" },
    yearlyReminderDays: { type: String, default: "30,15,7,3,1" },
