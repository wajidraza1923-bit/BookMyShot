...
const creatorSchema = new mongoose.Schema(
  {
    ...
    // Registration fields (Step 1-6)
    businessType: { type: String, enum: ["freelancer", "studio", "agency", ""], default: "" },
    teamSize: { type: String, enum: ["solo", "2-5", "6-10", "10+", ""], default: "" },
    yearsInBusiness: { type: String, default: "" },
    priceRange: { type: String, default: "" },
    travelPref: { type: String, default: "" },
    destinationWeddings: { type: Boolean, default: false },
    languages: [{ type: String }],
    servicesOffered: [{ type: String }],
    equipmentLevel: { type: String, enum: ["basic", "professional", "premium", ""], default: "" },
    editingIncluded: { type: Boolean, default: true },
    droneAvailable: { type: Boolean, default: false },
    liveStreaming: { type: Boolean, default: false },
    deliveryTime: { type: String, default: "7 Days" },
    ...
    subscriptionPlanType: { type: String, enum: ["monthly", "yearly"], default: "monthly" },
