...
const commissionSchema = new mongoose.Schema(
  {
    ...
    highestDealAmount: { type: Number, default: 0 },
    ...
    amountCollectedFromCustomer: { type: Number, default: 0 },
    status: {
      type: String,
      enum: ["pending", "partially_recovered", "recovered", "paid", "overdue", "cancelled"],
      default: "pending",
    },
    dueDate: { type: Date },
    paidAt: { type: Date },
